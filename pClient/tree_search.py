...
class SearchTree:
    ...
    def __init__(self,problem, strategy='breadth'): 
        ...
        root = SearchNode(problem.initial, None,0,0,self.problem.domain.heuristic(problem.goal))
    ...
    def search(self,limit=None):
        while self.open_nodes != []:
            ...
            for a in self.problem.domain.actions(node.state):
                ...
                newnode = SearchNode(newstate,node,node.depth+1, node.cost + 1, self.problem.domain.heuristic(self.problem.goal))
